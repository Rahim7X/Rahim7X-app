...
```shell
git clone https://github.com/Rahim7X/Rahim7X-app
```
...
5) Build a local version of your site by executing `hugo server`. You can see the site by navigating to `http://localhost:1313/Rahim7X-app/` (actual URL will be outputted in the CLI) in a browser.
...
`hugo.yaml`:
```yaml
baseURL: 'https://Rahim7X.github.io/Rahim7X-app'
title: 'Qubt Theme'
```
...
links:
  - github: https://github.com/Rahim7X/Rahim7X-app
  - link: https://github.com/Rahim7X/Rahim7X-app#readme
...
`https://Rahim7X.github.io/Rahim7X-app`